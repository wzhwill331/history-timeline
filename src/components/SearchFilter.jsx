...
const categories = ['全部', '战争', '文化', '科技', '政治', '经济']
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        ...
        <div className="relative flex-1 w-full sm:max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl border border-amber-200 bg-amber-50/50 text-amber-900 placeholder-amber-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all"
          />
          {query && (
            <button
